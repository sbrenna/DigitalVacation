...
static GFont s_time_font, s_date_font, s_weather_font, s_temp_font, s_digit_font, s_forecast_font, s_ampm_font;
...
static void update_time() {
  ...
  snprintf(hour_buffer, sizeof(hour_buffer), "%d%d\n%d%d", (int)digit_h_1, (int)digit_h_2, (int)digit_m_1, (int)digit_m_2);
  ...
  if(hour >= 21) {
	  text_layer_set_text(s_ampm_layer, hour_buffer);
...
static void main_window_load(Window *window) {
  ...
  s_ampm_font = fonts_load_custom_font(resource_get_handle(RESOURCE_ID_FONT_DIN_24));
